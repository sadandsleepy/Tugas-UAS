...
class MahasiswaEdit extends StatefulWidget {
  const MahasiswaEdit({Key? key, required this.mhs}) : super(key: key);
...
class _MahasiswaEditState extends State<MahasiswaEdit> {
  ...
  Widget build(BuildContext context) {
    ...
    namatxt.text = widget.mhs.nama;
    jurusantxt.text = widget.mhs.jurusan;
    nimtxt.text = widget.mhs.nim;
    kelamintxt.text = widget.mhs.jenis_kelamin;
    alamatxt.text = widget.mhs.alamat;
                        ...
                        Expanded(
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                border: InputBorder.none,
                                contentPadding: const EdgeInsets.symmetric(horizontal: 10),
                                hintText: widget.mhs.jenis_kelamin,
                                hintStyle:const TextStyle(
                                    fontSize: 15.0,
                                    color: Colors.black),
                              ),
  ...
  Future saveImg(BuildContext context) async {
    if(imageFile!=null){
  ...
  saveData(BuildContext context) {
    ...
    if(imageFile!=null){
      ...
      m.picture = widget.mhs.picture;
    }


    mahasiswaApiService.updateMahasiswa(
        id: widget.mhs.id,
        data: m
    );
  ...
  setupImage() {
    return imageFile == null
        ? NetworkImage(widget.mhs.picture)
        : FileImage(imageFile!);
  }
